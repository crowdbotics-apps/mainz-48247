"""
Django settings for mainz_48247 project.
...
WSGI_APPLICATION = 'mainz_48247.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "mainz_48247 API",
    "DESCRIPTION": "API documentation for mainz_48247 App",
    "VERSION": "v1",
}
